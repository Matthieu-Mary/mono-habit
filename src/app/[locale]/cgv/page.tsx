    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p>
            L&apos;Application est proposée gratuitement avec des
            fonctionnalités premium disponibles via des achats in-app. Les prix
            sont indiqués en euros TTC. Le paiement est effectué via les
            plateformes de paiement intégrées (App Store, Google Play).
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            pour tout achat effectué via l&apos;Application, sans avoir à
        ...
        <section>
          ...
          <p>
            ...
            notre politique de confidentialité et au Règlement Général sur la
